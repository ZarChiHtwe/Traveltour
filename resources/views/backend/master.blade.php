...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="{{asset('backendtemplate/vendor/fontawesome-free/css/all.min.css')}}">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Travel & Tours</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('hotels.index')}}">Hotel</a>
            <a class="collapse-item" href="{{route('cars.index')}}">Car</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Booking & Package:</h6>
            <a class="collapse-item" href="{{route('packages.index')}}">Package</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span><i class="fas fa-user text-gray-400" style="color: black; padding: 10px; border: 1px solid grey; border-radius: 20px;"></i></span>
              </a>
